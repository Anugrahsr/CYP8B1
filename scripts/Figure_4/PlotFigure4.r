...
barplot(as.matrix(t(Bar[,3:6])),col=c("red","blue","yellow","green"),xlab = "Individual id", ylab = "Fraction of reads", names.arg=Bar$SRR_ID,las=2,main="",space=0.35,cex.names = 2.5, font = 2,border="black",cex.lab=2.5, font.lab=2,cex=2.5)
